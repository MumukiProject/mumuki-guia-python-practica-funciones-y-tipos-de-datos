...
> Escribí la función `escribir_cartelito_optimo` que tome un título, un nombre y un apellido, y utilizando `escribir_cartelito` genere un cartelito corto o largo, según las reglas anteriores. Ejemplo:
>
> ```python
